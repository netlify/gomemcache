...
func testLocalhostU(t *testing.T) {
	t.Parallel()
	...
	testWithClientU(t, New(localhostTCPAddr))
}

// Run the memcached binary as a child process and connect to its unix socket.
func testUnixSocketU(t *testing.T) {
	t.Parallel()
...
func mustSetFU(t *testing.T, c *Client) func(*Item) {
	return func(it *Item) {
...
func testWithClientU(t *testing.T, c *Client) {
	...
	// We don't use these operations, they don't exist in our internal driver -PCN
	// XXX: Do we want to add them
	// // Append
...
func BenchmarkOnItemU(b *testing.B) {
